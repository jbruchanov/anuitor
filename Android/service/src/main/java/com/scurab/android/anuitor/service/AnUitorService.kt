...
private const val TAG = "AnUitorService"
private const val TITLE = "AnUitor"
private const val NOTIF_ID = 0x375012AF
private const val ROOT_FOLDER = "ROOT_FOLDER"
private const val DEFAULT_ROOT_FOLDER = "anuitor"
private const val DEFAULT_PORT = 8080

class AnUitorService : Service() {
    ...
    companion object {
        ...
        fun startService(context: Context, port: Int, overwriteWebFolder: Boolean = false) {
            ...
            GlobalScope.launch {
                ...
                if (exception == null) {
                    val intent = Intent(context, AnUitorService::class.java).apply {
                        action = START
