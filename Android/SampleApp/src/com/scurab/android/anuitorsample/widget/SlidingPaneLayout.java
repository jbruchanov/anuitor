...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private static final boolean HACK_MOD = true;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (HACK_MOD) {
                    if (adx > slop && ady > adx || canScroll(this, false, (int) Math.signum(x - mInitialMotionX), Math.round(x), Math.round(y))) {
                        mDragHelper.cancel();
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int x, int y) {
        ...
        if (HACK_MOD) {
            return checkV && (ViewCompat.canScrollHorizontally(v, -dx) ||
                    (((v instanceof HorizontallySwipable)) && ((HorizontallySwipable) v).canScrollHorizontally(-dx))
